package com.sinosoft.common.redis.utils;
...
public class RedisUtils {
     ...
     * @param key Redis键
     */
    public static <T> void delCacheMapKey(final String key) {
        // 获取 RMap 实例
        RMap<String, T> rMap = CLIENT.getMap(key);
        // 删除整个 Map
        rMap.delete();
     ...
     */
    public static <T> boolean hasHashKey(final String key, final String hKey) {
        RMap<String, T> rMap = CLIENT.getMap(key);
